...
**Due: October 8 before the class (10 am Pacific)**
...
As in Assignment 1, this project needs the Eigen library (if you have set this up for Assignment 1, then no change is needed). Place the `eigen` folder **next to** this assignment folder, not inside it:
